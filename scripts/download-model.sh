...
#   scripts/download-model.sh large-v3-turbo-q5_0   # most accurate; the setup window offers this too
#
...
MODEL="${1:-small.en}"
case "$MODEL" in
    tiny|tiny.en|base|base.en|small|small.en|medium|medium.en|large-v3|large-v3-turbo|large-v3-turbo-q5_0|large-v3-turbo-q8_0) ;;
    *) echo "Unknown model '$MODEL'. Try base.en, small.en, medium.en, large-v3-turbo-q5_0." >&2; exit 1 ;;
esac
